...
import com.bettem.modules.sys.dao.SysUserRoleDao;
...
public class SysUserRoleServiceImpl extends ServiceImpl<SysUserRoleDao, SysUserRoleEntity> implements SysUserRoleService {
	@Override
	public void saveOrUpdate(String userId, List<SysRoleEntity> roleIdList) {
		//先删除用户与角色关系
		...
		for(SysRoleEntity roleEntity : roleIdList){
	...
	@Override
	public List<SysRoleEntity> queryRoleIdList(String userId) {
